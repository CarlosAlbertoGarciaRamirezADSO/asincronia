...
async function llamar() {
    ...
    for (let i = 0; i < datos.length; i++) { //creamos un bucle que va a recorrer todos los datos de el json
        ...
        usuarioGithub.forEach(element => {// creamos un bucle que va a recorrer elemento por elemento los repositorios
            if(element.name.includes("javascript") || element.name.includes("Javascript")){// con el include miramos si existe un determinado elemento que estamos buscando(este caso javascript)
        ...
        console.log(usuarioGithub); // aca mostramos los datos de los usuarios para ver si tienen o no repositorios con el nombre
